...
export const metadata: Metadata = {
  title: "Abstract Global Wallet Onramp",
  description: "Example implementation of Abstract Global Wallet onramp integration for buying cryptocurrency with fiat currency",
};
