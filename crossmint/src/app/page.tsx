      ...
      <main className="relative flex flex-col items-center justify-center z-10 text-white text-center">
        <div className="flex flex-col items-center gap-8">
          <Image
            ...
            priority
          />
          <p className="text-md font-[family-name:var(--font-roobert)] max-w-md">
            Connect your Abstract Global Wallet and purchase NFTs with your credit card using Crossmint.
          </p>
