...
export function MintNft({ sessionSigner, session }: MintNftProps) {
    ...
    return (
        <div className="flex flex-col gap-4 w-full max-w-md">
            <button
                className="!h-11 min-h-[44px] rounded-full border border-solid transition-colors flex items-center justify-center text-white gap-2 text-sm px-5 font-[family-name:var(--font-roobert)] w-full bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 border-transparent"
                onClick={handleMint}
                disabled={isMinting}
            >
