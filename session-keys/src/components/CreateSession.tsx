...
export function CreateSession({ onSessionCreated }: CreateSessionProps) {
    ...
    return (
        <button
            className="rounded-full border border-solid transition-colors flex items-center justify-center text-white gap-2 text-sm h-16 py-4 px-5 font-[family-name:var(--font-roobert)] w-full sm:flex-1 bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 border-transparent"
